                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-md-8">
                            <h3 class="mb-0">สำรวจ
                                ...
                                {{$districts->districts_name }}</h3>
                        </div>
                        <div class="col-12 col-md-4 text-center  text-md-right">
                            <a href="{{route('form8.create')}}" class="btn  btn-primary">เพิ่มข้อมูล</a>
                        </div>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <a type="button" class="btn btn-info btn-sm" style="color:white"
                                            href="{{url('/forms-8/'.$row->form8s_id)}}">ดูข้อมูล</a>

                                        <a type="button" class="btn btn-danger btn-sm" style="color:white"
                                            href="{{URL('forms-8/delete/'.$row->form8s_id)}}"
