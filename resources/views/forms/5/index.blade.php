                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-12 col-md-8">
                            <h3 class="mb-0">การแลกเปลี่ยนเรียนรู้ที่เกี่ยวข้องกับงานด้านสุขภาพ หรือโรคระบาดต่างๆ
                            </h3>
                        </div>
                        <div class="col-12 col-md-4 text-center  text-md-right">
                            <a href="{{route('form5.create')}}" class="btn  btn-primary ">เพิ่มข้อมูล</a>
                        </div>
                    </div>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr >
                                    ...
                                    <td align="center">
                                        ...
                                        href="{{url('/forms-5/'.$row->form5s_id)}}">ดูข้อมูล</a>

                                        <a type="button" class="btn btn-danger btn-sm" style="color:white"
                                            href="{{URL('forms-5/delete/'.$row->form5s_id)}}"
