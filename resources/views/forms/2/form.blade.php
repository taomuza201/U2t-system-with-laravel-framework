                        ...
                        <section id="part-1">
                            ...
                            <div class="row align-items-center">
                                <div class="col-12  col-md-12">
                                    ...
                                    <select name="form2s_villages_id" id="form2s_villages_id" class="form-control" required autofocus>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12  col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="form2s_house_number"  name="form2s_house_number"
                                        required autofocus>
                                </div>
                                <div class="col-12  col-md-6">
                                    <label class="label_float"> เพศ : </label>
                                    <select name="form2s_sex" id="form2s_sex" class="form-control" required autofocus>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12  col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="form2s_name"name="form2s_name"
                                        required autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12  col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="form2s_age" name="form2s_age"
                                        required autofocus>
                                </div>
                                <div class="col-12  col-md-6">
                                    <label class="label_float"> ศาสนา : </label>
                                    <select name="form2s_religion" id="form2s_religion" class="form-control" required autofocus>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12  col-md-6">
                                    ...
                                    <select name="form2s_about_head_of_household" id="form2s_about_head_of_household" class="form-control" required autofocus>
                                ...
                                <div class="col-12  col-md-6">
                                    ...
                                    <select name="form2s_education_level" id="form2s_education_level" class="form-control" required autofocus>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12  col-md-6">
                                    ...
                                    <select name="form2s_occupation" id="form2s_occupation" class="form-control" required autofocus>
                                ...
                                <div class="col-12  col-md-6">
                                    <label class="label_float"> ความเชี่ยวชาญ : </label>                            
                                        <div class="form-group">
                                            <textarea id="my-textarea" class="form-control" name="form2s_expertise" rows="3"     autofocus></textarea>
                                        </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12  col-md-6">
                                    ...
                                    <select name="form2s_address_on" id="form2s_address_on" class="form-control" required autofocus>
                                ...
                                <div class="col-12  col-md-6">
                                    ...
                                    <select name="form2s_occupational_land" id="form2s_occupational_land" class="form-control" required autofocus>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12  col-md-6">
                                    ...
                                    <select name="form2s_saving_type" id="form2s_saving_type" class="form-control" required autofocus>
                                ...
                                <div class="col-12  col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="form2s_main_money" min="0" name="form2s_main_money" value="0" maxlength="9"
                            ...
                            <div class="row align-items-center">
                                <div class="col-12  col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="form2s_sub_money" min="0" name="form2s_sub_money" value="0" maxlength="9"
                                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"     required autofocus>
                                </div>
                                <div class="col-12  col-md-6">
                                    <label class="label_float"> รายจ่าย : </label>
                                    <input type="number" class="form-control" id="form2s_expenses" min="0" name="form2s_expenses" value="0" maxlength="9"
                                    oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"    required autofocus>
                                </div>
                            </div>
