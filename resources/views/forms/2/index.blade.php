                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-12 col-md-8">
                            <h3 class="mb-0">รวบรวม สำรวจ จัดเก็บข้อมูลด้านทรัพยากรมนุษย์ เชิงลึกของตำบล
                                {{$districts->districts_name }}</h3>
                        </div>
                        <div class="col-12 col-md-4 text-center  text-md-right">
                            <a href="{{route('form2.create')}}" class="btn  btn-primary">เพิ่มข้อมูล</a>
                        </div>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <a type="button" class="btn btn-info btn-sm" style="color:white"
                                            href="{{url('/forms-2/'.$row->form2s_id )}}">ดูข้อมูล</a>

                                        <a type="button" class="btn btn-danger btn-sm" style="color:white"
                                            href="{{URL('forms-2/delete/'.$row->form2s_id )}}"
