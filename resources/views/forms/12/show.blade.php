@extends('layouts.template', ['title' => __('ความรู้ที่จำเป็นในการถ่ายทอดเทคโนโลยีที่สอดคล้องกับธรรมชาติการเรียนรู้ ศักยภาพ และความต้องการของชุมชน')])
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <section id="part-1">
                            ...
                            <div class="row align-items-center">
                                <div class="col-12  col-md-12">
                                    <label class="label_float"> เว็บไซต์ : </label>
                                    <p style="text-indent: 2.5em;">
                                        {{$form->form12s_refer}}
                                    </p>
                                </div>
