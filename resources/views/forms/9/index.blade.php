                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-md-8">
                            <h3 class="mb-0">แนวทางการจัดการเรียนรู้ที่มีประสิทธิภาพ
                                สอดคล้องกับธรรมชาติการเรียนรู้และบริบทของชุมชน {{$districts->districts_name }}
                            </h3>
                        </div>
                        <div class="col-12 col-md-4 text-center  text-md-right">
                            <a href="{{route('form9.create')}}" class="btn  btn-primary ">เพิ่มข้อมูล</a>
                        </div>
                    </div>
                </div>
                                ...
                                <tr href="{{url('/forms-9/'.$row->form9s_id)}}">
                                    ...
                                    <td align="center">
                                        <a type="button" class="btn btn-info btn-sm" style="color:white"
                                            href="{{url('/forms-9/'.$row->form9s_id)}}">ดูข้อมูล</a>

                                        <a type="button" class="btn btn-danger btn-sm" style="color:white"
                                            href="{{URL('forms-9/delete/'.$row->form9s_id)}}"
