@extends('layouts.template', ['title' => __('เป้าหมายที่ 3 สามารถวิเคราะห์รายรับรายจ่ายของสถาบันการเงินชุมชน ธนาคารชุมชน')])
...
<div class="container-fluid mt--7">
    ...
    <form action="{{$goals_3s->goals_3s_id}}/update" method="post" enctype="multipart/form-data" id="myForm">
        @csrf
                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-md-7">
                                <div class="custom-control custom-radio">
                                    ...
                                    <span>
                                        <textarea type="text" class="form-control" id="goals_3s_problem"
...
$.get(  {{$goals_3s->goals_3s_id}}+ '/edit', function (data) {
  
    $('#goals_3s_at_name').val(data.goals_3s_at_name);
    $('#goals_3s_address').val(data.goals_3s_address);
    $('#goals_3s_problem').val(data.goals_3s_problem);


    $("input[name=goals_3s_indicators_1][value=" + data.goals_3s_indicators_1 + "]").prop('checked', true);
    $("input[name=goals_3s_indicators_2][value=" + data.goals_3s_indicators_2 + "]").prop('checked', true);
    $("input[name=goals_3s_indicators_3][value=" + data.goals_3s_indicators_3 + "]").prop('checked', true);
    $("input[name=goals_3s_indicators_4][value=" + data.goals_3s_indicators_4 + "]").prop('checked', true);
    $("input[name=goals_3s_indicators_5][value=" + data.goals_3s_indicators_5 + "]").prop('checked', true);
    $("input[name=goals_3s_indicators_6][value=" + data.goals_3s_indicators_6 + "]").prop('checked', true);
    $("input[name=goals_3s_indicators_7][value=" + data.goals_3s_indicators_7 + "]").prop('checked', true);
    $("input[name=goals_3s_indicators_8][value=" + data.goals_3s_indicators_8 + "]").prop('checked', true);
    $("input[name=goals_3s_indicators_9][value=" + data.goals_3s_indicators_9 + "]").prop('checked', true);
    $("input[name=goals_3s_indicators_10][value=" + data.goals_3s_indicators_10 + "]").prop('checked', true);
    $("input[name=goals_3s_indicators_11][value=" + data.goals_3s_indicators_11 + "]").prop('checked', true);


    let data_indicators  = [data.goals_3s_indicators_1_refer, data.goals_3s_indicators_2_refer,data.goals_3s_indicators_3_refer,data.goals_3s_indicators_4_refer,data.goals_3s_indicators_5_refer,data.goals_3s_indicators_6_refer,data.goals_3s_indicators_7_refer,data.goals_3s_indicators_8_refer,data.goals_3s_indicators_9_refer,data.goals_3s_indicators_10_refer,data.goals_3s_indicators_11_refer];

    let data_indicators_name  = [data.goals_3s_indicators_1_name, data.goals_3s_indicators_2_name,data.goals_3s_indicators_3_name,data.goals_3s_indicators_4_name,data.goals_3s_indicators_5_name,data.goals_3s_indicators_6_name,data.goals_3s_indicators_7_name,data.goals_3s_indicators_8_name,data.goals_3s_indicators_9_name,data.goals_3s_indicators_10_name,data.goals_3s_indicators_11_name];
    for(i = 1; i <=11 ; i++){
    let goals_3s_indicators_refer_file = document.getElementById('goals_3s_indicators_'+i+'_refer_file');
    let children = '<li>     <a href="{{URL('goals/goals_3s')}}/'+data_indicators[i-1]+'" download="'+data_indicators_name[i-1]+'">' + data_indicators_name[i-1] + '</a> </li>';

    if(data_indicators_name[i-1] != null){
        goals_3s_indicators_refer_file.innerHTML = '<ul>'+children+'</ul>';
    }
    ...
    $("input[name=goals_3s_operation_1][value=" + data.goals_3s_operation_1 + "]").prop('checked', true);
    $("input[name=goals_3s_operation_2][value=" + data.goals_3s_operation_2 + "]").prop('checked', true);
    $("input[name=goals_3s_operation_3][value=" + data.goals_3s_operation_3 + "]").prop('checked', true);
    $("input[name=goals_3s_operation_4][value=" + data.goals_3s_operation_4 + "]").prop('checked', true);
    $("input[name=goals_3s_operation_5][value=" + data.goals_3s_operation_5 + "]").prop('checked', true);
    $("input[name=goals_3s_operation_6][value=" + data.goals_3s_operation_6 + "]").prop('checked', true);


    let data_operation  = [data.goals_3s_operation_1_refer, data.goals_3s_operation_2_refer,data.goals_3s_operation_3_refer,data.goals_3s_operation_4_refer,data.goals_3s_operation_5_refer,data.goals_3s_operation_6_refer];
    let data_operation_name = [data.goals_3s_operation_1_name, data.goals_3s_operation_2_name,data.goals_3s_operation_3_name,data.goals_3s_operation_4_name,data.goals_3s_operation_5_name,data.goals_3s_operation_6_name];


    for(i = 1; i <=6 ; i++){
    let goals_3s_operation_refer_file = document.getElementById('goals_3s_operation_'+i+'_refer_file');
    
    let children = '<li>     <a href="{{URL('goals/goals_3s')}}/'+data_operation[i-1]+'" download="'+data_operation_name[i-1]+'">' + data_operation_name[i-1] + '</a> </li>';

    
    if(data_operation_name[i-1] != null){
        goals_3s_operation_refer_file.innerHTML = '<ul>'+children+'</ul>';
    }
