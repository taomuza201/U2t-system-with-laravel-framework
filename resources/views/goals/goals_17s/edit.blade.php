...
<div class="container-fluid mt--7">
    ...
    <form action="{{$goals_17s->goals_17s_id}}/update" method="post" enctype="multipart/form-data" id="myForm">
        @csrf
...
$.get(  {{$goals_17s->goals_17s_id}}+ '/edit', function (data) {
  
    $('#goals_17s_people').val(data.goals_17s_people);
    $('#goals_17s_male').val(data.goals_17s_male);
    $('#goals_17s_female').val(data.goals_17s_female);

    $('#goals_17s_age_1_14').val(data.goals_17s_age_1_14);
    $('#goals_17s_age_15_35').val(data.goals_17s_age_15_35);
    $('#goals_17s_age_36_56').val(data.goals_17s_age_36_56);
    $('#goals_17s_age_57_plus').val(data.goals_17s_age_57_plus);


    $('#goals_17s_area_size').val(data.goals_17s_area_size);
