...
@section('content')
@include('blog.blog_details.edit.header', [
'title' => __('ไดอารี่ ') ,
])
        ...
        <div class="col">
            <div class="card shadow">
                ...
                <div class="col-12">
                    ...
                    <form action="{{ URL('blog_details/'.$id.'/update')}}" method="post" id="submitform" class="mt-4"
                        enctype="multipart/form-data">
                        <span>ชื่อเรื่อง </span>
                        <input class="form-control" type="text" name="blog_details_title" id="blog_details_title" value="{{$blog_detail->blog_details_title}}"
                            required>
                        <span>รายละเอียด </span>
                        <textarea name="blog_details_body" id="blog_details_body" required>{{$blog_detail->blog_details_body}}</textarea>
                        <input type="hidden" name="blog_details_blog_subjects_id" id="blog_details_blog_subjects_id"
                            value="{{$blog_details_blog_subjects_id}}">
