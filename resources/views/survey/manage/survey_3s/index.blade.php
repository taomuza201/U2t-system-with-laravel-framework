@extends('layouts.template', ['title' => __('แบบสำรวจชุดที่ 3 สำหรับศาสนสถาน')])
                        ...
                        <div class="col-12 col-md-7  text-right">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder=" ค้นหาศาสนสถาน" id="search">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush table-striped" id="myTable">
                            ...
                            <tbody>
                                ...
                                @foreach ($survey_3s as $row)
                                <tr {{-- href="{{URL('manage_survey/survey_3s/'.$row->survey_3s_id)}}" --}}>
                                    <td align="center"></td>
                                    <td>{{$row->survey_3s_religious_place}}</td>
                                    <td>{{$row->survey_3s_address}}</td>
...
<script>
    ...
    function exportexcel() {
        ...
        window.location.href = "export/" + districts + '/survey_3s';
