@extends('layouts.template', ['title' => __('แบบสำรวจชุดที่ 1 สำหรับที่พักอาศัย')])
                        ...
                        <div class="col-12 col-md-7  text-right">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder=" ค้นหาบ้าน" id="search">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush table-striped" id="myTable">
                            ...
                            <tbody>
                                ...
                                @foreach ($survey_1s as $row)
                                <tr {{-- href="{{URL('manage_survey/survey_1s/'.$row->survey_1s_id)}}" --}}>
                                    <td align="center"></td>
                                    <td>{{$row->survey_1s_address}}</td>
...
<script>
    ...
    function exportexcel() {
        ...
        window.location.href = "export/" + districts+'/survey_1s';
