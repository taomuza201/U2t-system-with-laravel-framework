                        ...
                        <div class="row align-items-center">
                            <div class="col-12 col-md-7">
                                <div class="custom-control custom-radio">
                                    ...
                                    <span>
                                        <select
                                            class="form-control{{ $errors->has('survey_1s_villages') ? ' is-invalid' : '' }}"
                                            name="survey_1s_villages" id="survey_1s_villages" required>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <center>
                                                ...
                                                <label>มี</label>
                                                <input type="radio" name="survey_1s_no_1" id="survey_1s_no_1" value="no"
                                                    required>
                                                <label>ไม่มี</label>
                                            </center>
                                        </td>
                                    ...
                                    <tr class="border_top">
                                        <td class="screen" style="white-space: normal; "> 2.
                                            มีการสังเกตอาการของตนเองและบุคคลที่อาศัยอยู่ร่วมกัน หากพบว่ามีไข้ ร่วมกับไอ
                                            มีน้ำมูก เจ็บคอ จมูกไม่ได้กลิ่น ลิ้นไม่รับรส หายใจเร็ว หายใจเหนื่อย
                                            หรือหายใจลำบากอย่างใดอย่างหนึ่ง และอาจมีอาการ ท้องเสียร่วมด้วย
                                            ให้รีบไปพบแพทย์ทันที หรือไม่
                                    <tr>
                                        <td>
                                            <center>
                                                <input type="radio" name="survey_1s_no_2" id="survey_1s_no_2"
                                                    value="yes" checked required>
                                                <label>มี</label>
                                                <input type="radio" name="survey_1s_no_2" id="survey_1s_no_2" value="no"
                                                    required>
                                                <label>ไม่มี</label>
                                            </center>
                                        </td>
                                    ...
                                    <tr class="border_top">
                                        <td class="screen" style="white-space: normal; "> 3.
                                            ...
                                            หรือเจลแอลกอฮอล์โดยเฉพาะก่อนเตรียม ปรุงอาหาร ก่อนรับประทานอาหาร
                                            หลังเข้าห้องน้ำ หลังหยิบจับสิ่งสกปรก หลังเยี่ยมผู้ป่วยในสถานพยาบาล
                                            หลังสัมผัสหรือเล่นกับสัตว์เลี้ยง และหลังกลับจากนอกบ้าน หรือไม่
                                    <tr>
                                        <td>
                                            <center>
                                                <input type="radio" name="survey_1s_no_3" id="survey_1s_no_3"
                                                    value="yes" checked required>
                                                <label>มี</label>
                                                <input type="radio" name="survey_1s_no_3" id="survey_1s_no_3" value="no"" required>
                                                <label>ไม่มี</label>
                                            </center>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <textarea
                                                class="
                                                    form-control{{ $errors->has('survey_1s_no_3_note') ? ' is-invalid' : '' }}"
                                        ...
                                        <td>
                                            <center>
                                                <input type="radio" name="survey_1s_no_4" id="survey_1s_no_4"
                                                    value="yes" checked required>
                                                <label>มี</label>
                                                <input type="radio" name="survey_1s_no_4" id="survey_1s_no_4" value="no"
                                                    required>
                                                <label>ไม่มี</label>
                                            </center>
                                        </td>
                                    ...
                                    <tr class="border_top">
                                        <td class="screen" style="white-space: normal; "> 5.
                                            ไม่ใช้สิ่งของเครื่องใช้ส่วนตัวร่วมกัน เช่น ผ้าเช็ดหน้า ผ้าเช็ดตัว ช้อน
                                            แก้วน้ำ หลอดดูดน้ำ หรือไม่
                                    <tr>
                                        <td>
                                            <center>
                                                <input type="radio" name="survey_1s_no_5" id="survey_1s_no_5"
                                                    value="yes" checked required>
                                                <label>มี</label>
                                                <input type="radio" name="survey_1s_no_5" id="survey_1s_no_5" value="no"
                                                    required>
                                                <label>ไม่มี</label>
                                            </center>
                                        </td>
                                    ...
                                    <tr class="border_top">
                                        <td class="screen" style="white-space: normal; ">6.
                                            เมื่อกลับจากการทำภารกิจหรือกิจกรรมนอกบ้าน ให้ล้างมือ ชำระร่างกาย
                                            เปลี่ยนเครื่องแต่งกายทันที หรือไม่
                                    <tr>
                                        <td>
                                            <center>
                                                <input type="radio" name="survey_1s_no_6" id="survey_1s_no_6"
                                                    value="yes" checked required>
                                                <label>มี</label>
                                                <input type="radio" name="survey_1s_no_6" id="survey_1s_no_6" value="no"
                                                    required>
                                                <label>ไม่มี</label>
                                            </center>
                                        </td>
