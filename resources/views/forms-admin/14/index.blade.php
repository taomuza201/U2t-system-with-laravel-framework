@extends('layouts.app')
@section('pageTitle', 'ประชาสัมพันธ์/สร้างความเข้าใจกับชุมชน ในกระบวนการด้านการถ่ายทอดความรู้')
@section('content')
@include('layouts.headers.normal', [
'title' => ('ประชาสัมพันธ์/สร้างความเข้าใจกับชุมชน ในกระบวนการด้านการถ่ายทอดความรู้
' ),
])
                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-12 col-md-8 mb-2">
                            <h3 class="mb-0">ประชาสัมพันธ์/สร้างความเข้าใจกับชุมชน ในกระบวนการด้านการถ่ายทอดความรู้
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush table-striped" id="maintable">
                            ...
                            <tbody>
                                ...
                                @endphp
                                @foreach ($form as $row)
                                <tr href="{{url('/forms-14/'.$row->form14s_id)}}">
                                    <td align="center">{{$count }}</td>
                                    <td align="center">{{$row->districts_name  }}</td>
                                    <td align="center">{{$row->form14s_title}}</td>
...
<script>
    ...
    function export_doc() {
        ...
        let win = window.open('forms-14-admin/report/' + districts, '_blank');
    }
