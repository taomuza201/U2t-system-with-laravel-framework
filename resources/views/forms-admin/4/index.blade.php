@extends('layouts.app')
@section('pageTitle', 'ความรู้ด้านการจัดการโรคระบาดที่เกี่ยวข้อง')
@section('content')
@include('layouts.headers.normal', [
'title' => ('ความรู้ด้านการจัดการโรคระบาดที่เกี่ยวข้อง' ),
])
                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-12 col-md-8 mb-2">
                            <h3 class="mb-0">ความรู้ด้านการจัดการโรคระบาดที่เกี่ยวข้อง <button onclick="export_doc()"
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush table-striped" id="maintable">
                            ...
                            <tbody>
                                ...
                                @endphp
                                @foreach ($form as $row)
                                <tr href="{{url('/forms-4/'.$row->form4s_id)}}">
                                    <td align="center">{{$count }}</td>
                                    <td align="center">{{$row->districts_name  }}</td>
                                    <td align="center">{{$row->form4s_title}}</td>
...
<script>
    ...
    function export_doc() {
        ...
        let win = window.open('forms-4-admin/report/'+districts, '_blank');
    }
