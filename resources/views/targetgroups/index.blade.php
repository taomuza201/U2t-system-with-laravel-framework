            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class=" col-md-2 text-right   col-sm-10 text-sm-center">
                            <button href="" class="btn btn-sm btn-primary btn-block" id="addtargetgroupsModal"
                                data-toggle="modal">เพิ่มข้อมูลกลุ่มเป้าหมาย
